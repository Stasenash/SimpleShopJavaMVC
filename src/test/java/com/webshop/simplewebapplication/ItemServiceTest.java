...
class ItemServiceTest {
	...
	@Test
	void addItem() {
		Item item = new Item(0, "Морковь", 17, "435633453", new Category(0, "Техника"), new MyUser());
	...
	void findAll() {
		...
		itemList.add(new Item(0, "Морковь", 17, "957643956", new Category(0, "Продукты2"), new MyUser()));
